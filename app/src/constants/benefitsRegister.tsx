...
export const adTextStore ="Por que escolher nossa plataforma para criar sua loja?"
export const adLinkStore= "Crie sua loja agora mesmo e comece a faturar com facilidade e segurança."

export const benefitsCreateStore = [
    {
